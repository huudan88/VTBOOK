<!-- Modal update borrow Book-->
<div class="modal fade" id="updBrrBook" tabindex="-1" aria-labelledby="updBrrBooklbl" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="updBrrBooklbl">Update borrow</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <!-- Form update borrow-->
            <form class="row g-3" action="/VTBook/Borrow/updBrrBook"  method="post">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" name="btnSubmitUpdBrr" id="btnSubUpdBrr">Submit</button>
                </div>
            </form>
        </div>
        </div>
